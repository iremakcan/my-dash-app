...
# Ensure correct relative path to the CSV file
gii_data = pd.read_csv(os.path.join(os.getcwd(), "Gender_Inequality_Index.csv"))

violence_data = pd.read_csv(os.path.join(os.getcwd(), "violence_data.csv"))
...
final_data = pd.read_excel(os.path.join(os.getcwd(), "final_merged_data.xls"))
...
cleaned_file_path = pd.read_csv(os.path.join(os.getcwd(), "final_cleaned_data.csv"))
...
data = pd.read_csv(os.path.join(os.getcwd(), "final_cleaned_data.csv"))
...
# Load dataset
df = pd.read_csv(os.path.join(os.getcwd(), "final_cleaned_data.csv"))
